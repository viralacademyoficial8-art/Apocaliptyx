        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg">
            ...
            <div className="relative bg-card border border-border rounded-2xl overflow-hidden">
              ...
              <div className="relative bg-gradient-to-r from-red-600/20 via-purple-600/20 to-pink-600/20 px-6 py-5 border-b border-border">
                ...
                <div className="relative flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Comparte con tu audiencia en vivo</p>
                    </div>
                  </div>
                  <button
                    onClick={() => !isStartingStream && setShowStartModal(false)}
              ...
              <div className="p-6 space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-muted/50 border border-border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"
                      disabled={isStartingStream}
                      maxLength={100}
                    />
                  </div>
                  <p className="text-xs text-muted-foreground mt-1">{streamTitle.length}/100 caracteres</p>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-3 bg-muted/50 border border-border rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all resize-none"
                    disabled={isStartingStream}
                    maxLength={500}
                  />
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                <Button
                  ...
                  className={`text-sm ${filter === 'live' ? 'bg-red-600' : 'border-border'}`}
                  size="sm"
                >
                ...
                <Button
                  ...
                  className={`text-sm ${filter === 'following' ? 'bg-purple-600' : 'border-border'}`}
                  size="sm"
                >
        ...
        {isLoading ? (
          ...
          <div className="lg:w-80 xl:w-96 space-y-6">
            ...
            <div className="bg-muted/50 rounded-xl border border-border overflow-hidden">
              <div className="px-4 py-3 border-b border-border bg-gradient-to-r from-red-600/20 to-pink-600/20">
            ...
            <div className="bg-muted/50 rounded-xl border border-border overflow-hidden">
              <div className="px-4 py-3 border-b border-border bg-gradient-to-r from-gray-600/20 to-gray-500/20">
                <h3 className="font-semibold flex items-center gap-2">
                ...
                {sidebar.ended.length > 0 ? (
                  sidebar.ended.slice(0, 5).map((stream) => (
                    <Link
                      ...
                      className="flex items-center gap-3 p-3 hover:bg-muted/30 transition-colors opacity-75 hover:opacity-100"
                    >
            ...
            {/* Categories Section */}
            <div className="bg-muted/50 rounded-xl border border-border overflow-hidden">
              <div className="px-4 py-3 border-b border-border bg-gradient-to-r from-purple-600/20 to-blue-600/20">
                <h3 className="font-semibold flex items-center gap-2">
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="flex items-center gap-2 text-xs">
                          ...
                          <span className="text-muted-foreground">{cat.totalStreams} total</span>
                        </span>
                      </button>
                    );
                  })
