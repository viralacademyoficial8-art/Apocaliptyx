    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Colecciona insignias y demuestra tu experiencia</p>
        </div>
          ...
          <div className="grid gap-4 mb-8">
            <div className="flex items-center gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Completa tu primera predicción</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Gana tu primera predicción</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Acierta 5 predicciones seguidas</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Llega al top 10 del leaderboard</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Crea 10 escenarios populares</p>
              </div>
            </div>
          </div>

          <div className="bg-card/50 border border-border rounded-xl p-6 mt-8">
            <h3 className="font-bold text-foreground mb-2">Ver tus insignias</h3>
