    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Guía para participar en la comunidad</p>
        </div>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Usa el buscador para encontrar discusiones sobre escenarios específicos.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Comparte tus análisis, preguntas o predicciones con la comunidad.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Da upvote a posts útiles y participa en las discusiones.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Si ves contenido inapropiado, repórtalo para que los moderadores lo revisen.</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          ...
          <div className="grid gap-2">
            <Link href="/ayuda/mensajes-privados" className="text-muted-foreground hover:text-foreground transition-colors">
