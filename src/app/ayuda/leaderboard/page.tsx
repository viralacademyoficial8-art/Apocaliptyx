    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">El sistema de clasificación de profetas</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Porcentaje de predicciones acertadas</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">AP Coins ganados en escenarios</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Tu nivel general en la plataforma</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-3 mb-8">
            <div className="bg-card/50 border border-border rounded-lg p-4">
              ...
              <p className="text-sm text-muted-foreground">Todos los usuarios de todos los tiempos</p>
            </div>
            <div className="bg-card/50 border border-border rounded-lg p-4">
              <h3 className="font-semibold text-white">📅 Semanal</h3>
              <p className="text-sm text-muted-foreground">Los mejores de la semana actual</p>
            </div>
            <div className="bg-card/50 border border-border rounded-lg p-4">
              <h3 className="font-semibold text-white">📊 Por categoría</h3>
              <p className="text-sm text-muted-foreground">Los mejores en Deportes, Economía, etc.</p>
            </div>
          </div>
