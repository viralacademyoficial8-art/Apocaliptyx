    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Políticas y normas de la comunidad</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <ul className="space-y-2 mb-8">
            <li className="text-foreground">• <strong>Primera infracción:</strong> Advertencia y eliminación del escenario</li>
            <li className="text-foreground">• <strong>Segunda infracción:</strong> Suspensión temporal de crear escenarios</li>
            <li className="text-foreground">• <strong>Infracciones graves:</strong> Suspensión o ban permanente de la cuenta</li>
          </ul>
