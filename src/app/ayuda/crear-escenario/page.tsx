    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Guía completa para crear predicciones</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="space-y-6 mb-8">
            <div className="bg-card/50 border border-border rounded-lg p-5">
              ...
              <ul className="space-y-2 text-foreground ml-12">
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              ...
              <p className="text-foreground">&quot;¿Quién ganará el Super Bowl 2026?&quot;</p>
              <p className="text-sm text-muted-foreground mt-1">Claro, verificable, con fecha definida</p>
            </div>

            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              <p className="text-red-400 font-medium mb-2">✗ Mal escenario</p>
              <p className="text-foreground">&quot;¿Será un buen año para el fútbol?&quot;</p>
              <p className="text-sm text-muted-foreground mt-1">Subjetivo, no verificable objetivamente</p>
            </div>
          </div>
