    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Información sobre devoluciones y reembolsos</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <p className="text-foreground mb-4">Solo consideramos reembolsos en casos excepcionales:</p>
          
          <div className="space-y-3 mb-8">
            <div className="flex items-start gap-3 bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" />
              <div>
                <p className="text-foreground"><strong>Error técnico comprobable</strong></p>
                <p className="text-sm text-muted-foreground">Si pagaste pero no recibiste los AP Coins por un error de nuestro sistema.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" />
              <div>
                <p className="text-foreground"><strong>Cobro duplicado verificable</strong></p>
                <p className="text-sm text-muted-foreground">Si se te cobró dos veces por la misma transacción.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 mb-8">
            {[
              ...
              <div key={item} className="flex items-center gap-3 bg-card/50 border border-border rounded-lg p-3">
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6 mt-8">
            ...
            <p className="text-sm text-muted-foreground mt-2">Tiempo de respuesta: 24-48 horas hábiles</p>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          ...
          <div className="grid gap-2">
            ...
            <Link href="/terminos-y-condiciones" className="text-muted-foreground hover:text-foreground transition-colors">
