    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Mantén tu cuenta segura</p>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          ...
          <div className="grid gap-2">
            ...
            <Link href="/ayuda/recuperar-cuenta" className="text-muted-foreground hover:text-foreground transition-colors">
