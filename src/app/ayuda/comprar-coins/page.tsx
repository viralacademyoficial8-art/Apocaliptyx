    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Guía para adquirir paquetes de AP Coins</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start gap-4">
              ...
              <div className="bg-card/50 border border-border rounded-lg p-4 flex-1">
                ...
                <p className="text-sm text-muted-foreground">Haz clic en &quot;Tienda&quot; en el menú o ve directamente a <Link href="/tienda" className="text-orange-400">/tienda</Link></p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="bg-card/50 border border-border rounded-lg p-4 flex-1">
                ...
                <p className="text-sm text-muted-foreground">Elige el paquete que mejor se adapte a tus necesidades. Los paquetes más grandes suelen tener bonificaciones.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="bg-card/50 border border-border rounded-lg p-4 flex-1">
                ...
                <p className="text-sm text-muted-foreground">Ingresa los datos de tu tarjeta. El pago se procesa de forma segura con Stripe.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="bg-card/50 border border-border rounded-lg p-4 flex-1">
                ...
                <p className="text-sm text-muted-foreground">Los AP Coins se acreditan instantáneamente a tu cuenta.</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 bg-card/50 border border-border rounded-lg p-4 mb-8">
            <CreditCard className="w-6 h-6 text-blue-400" />
            <div>
              <p className="text-foreground">Tarjetas de crédito y débito (Visa, Mastercard, American Express)</p>
              <p className="text-sm text-muted-foreground">Procesado de forma segura por Stripe</p>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          ...
          <div className="grid gap-2">
            <Link href="/ayuda/metodos-pago" className="text-muted-foreground hover:text-foreground transition-colors">
