    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Lleva tu experiencia al siguiente nivel</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="space-y-3 mb-8">
            {[
              ...
              <div key={index} className="flex items-center gap-3 bg-gray-900/50 border border-gray-800 rounded-lg p-4">
