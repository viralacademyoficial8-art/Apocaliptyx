    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Todas las formas de conseguir AP Coins sin pagar</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="space-y-6">
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              ...
              <p className="text-gray-400">Al crear tu cuenta, recibes automáticamente 1,000 AP Coins para empezar.</p>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              ...
              <p className="text-gray-400">Inicia sesión cada día para reclamar tu recompensa. ¡La racha consecutiva aumenta el premio!</p>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              ...
              <p className="text-gray-400">Cuando aciertas un escenario, ganas AP Coins del pool. ¡Es la mejor forma de multiplicar tus coins!</p>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              ...
              <p className="text-gray-400">Completa logros (primera predicción, racha de aciertos, etc.) y misiones semanales para ganar recompensas.</p>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              ...
              <p className="text-gray-400">Invita amigos con tu código de referido. Cuando se registren y hagan su primera predicción, ambos ganan.</p>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-6">
              ...
              <p className="text-gray-400">Durante eventos especiales y promociones, hay oportunidades extra de ganar AP Coins. ¡Mantente atento!</p>
            </div>
          </div>
