    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Opciones disponibles para comprar AP Coins</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="grid gap-3 mb-8">
            {[
              ...
              <div key={card.name} className="flex items-center gap-3 bg-gray-900/50 border border-gray-800 rounded-lg p-4">
          ...
          <div className="flex items-start gap-3 bg-gray-900/50 border border-gray-800 rounded-lg p-4 mb-8">
