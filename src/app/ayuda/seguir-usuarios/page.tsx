    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Conecta con otros profetas</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="space-y-3 mb-8">
            <div className="flex items-center gap-3 bg-card/50 border border-border rounded-lg p-4">
              ...
              <span className="text-foreground">Ve sus predicciones y escenarios en tu feed</span>
            </div>
            <div className="flex items-center gap-3 bg-card/50 border border-border rounded-lg p-4">
              <Bell className="w-5 h-5 text-yellow-400" />
              <span className="text-foreground">Recibe notificaciones de sus nuevas predicciones</span>
            </div>
            <div className="flex items-center gap-3 bg-card/50 border border-border rounded-lg p-4">
              <UserPlus className="w-5 h-5 text-green-400" />
              <span className="text-foreground">Construye tu red de profetas confiables</span>
            </div>
          </div>
