    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Guía para hacer predicciones y apostar</p>
        </div>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start gap-4">
              ...
              <div className="bg-card/50 border border-border rounded-lg p-4 flex-1">
                ...
                <p className="text-sm text-muted-foreground">Navega por el dashboard o usa el buscador para encontrar escenarios que te interesen.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="bg-card/50 border border-border rounded-lg p-4 flex-1">
                ...
                <p className="text-sm text-muted-foreground">Revisa la descripción, las opciones disponibles, la fecha de cierre y las probabilidades actuales.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="bg-card/50 border border-border rounded-lg p-4 flex-1">
                ...
                <p className="text-sm text-muted-foreground">Selecciona la opción que crees que será la correcta.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="bg-card/50 border border-border rounded-lg p-4 flex-1">
                ...
                <p className="text-sm text-muted-foreground">Ingresa la cantidad de AP Coins que quieres apostar. Verás las ganancias potenciales.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="bg-card/50 border border-border rounded-lg p-4 flex-1">
                ...
                <p className="text-sm text-muted-foreground">Revisa tu predicción y confirma. ¡Los AP Coins se deducirán de tu cuenta!</p>
              </div>
            </div>
          </div>
