    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Activa todas las funciones de tu cuenta</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="space-y-3 mb-8">
            <div className="flex items-center gap-3 bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              ...
              <span className="text-gray-300">Acceso completo a todas las funciones</span>
            </div>
            <div className="flex items-center gap-3 bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <Shield className="w-5 h-5 text-blue-400" />
              <span className="text-gray-300">Mayor seguridad para tu cuenta</span>
            </div>
            <div className="flex items-center gap-3 bg-gray-900/50 border border-gray-800 rounded-lg p-4">
              <Mail className="w-5 h-5 text-purple-400" />
              <span className="text-gray-300">Recibir notificaciones importantes</span>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          ...
          <div className="grid gap-2">
            ...
            <Link href="/ayuda/personalizar-perfil" className="text-gray-400 hover:text-white transition-colors">
