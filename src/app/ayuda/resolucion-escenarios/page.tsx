    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">El proceso de verificación y pago de resultados</p>
        </div>
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-start gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Cuando llega la fecha de cierre, ya no se aceptan más predicciones. El pool queda bloqueado.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">El creador del escenario o los moderadores verifican el resultado usando fuentes públicas confiables.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">En algunos casos, hay un período donde los usuarios pueden disputar el resultado si creen que es incorrecto.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-card/50 border border-border rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Las ganancias se distribuyen automáticamente a los ganadores según sus apuestas.</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          ...
          <div className="grid gap-2">
            ...
            <Link href="/ayuda/reglas-escenarios" className="text-muted-foreground hover:text-foreground transition-colors">
