    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-sm">(Integrada: LFPDPPP – México + GDPR – Unión Europea)</p>
          <p className="text-muted-foreground mt-2">Última actualización: 2 de enero de 2026</p>
          <p className="text-muted-foreground">Responsable del tratamiento: Apocalyptix</p>
          <p className="text-muted-foreground">Correo de contacto: contacto@apocaliptyx.com</p>
        </div>
