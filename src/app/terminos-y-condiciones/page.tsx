      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="space-y-8">
          ...
          <section className="p-6 bg-card/30 border border-border rounded-xl">
            ...
            <p className="text-foreground leading-relaxed mb-2">El Usuario es responsable de:</p>
            <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
          ...
          <section className="p-6 bg-card/30 border border-border rounded-xl">
            ...
            <p className="text-foreground leading-relaxed mb-4">El Usuario se obliga a no utilizar Apocalyptix para:</p>
            <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
          ...
          <section className="p-6 bg-card/30 border border-border rounded-xl">
            ...
            <p className="text-foreground leading-relaxed mb-4">El Usuario reconoce que:</p>
            <ul className="list-disc list-inside text-foreground space-y-2 ml-4">
