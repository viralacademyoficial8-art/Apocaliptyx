      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 safe-area-left safe-area-right">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="hidden md:flex items-center gap-1 bg-muted/50 dark:bg-zinc-900/50 backdrop-blur-sm rounded-full p-1 border border-border">
              {navItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="flex items-center gap-2 px-5 py-2 text-muted-foreground hover:text-foreground rounded-full hover:bg-muted transition-all duration-200"
                  >
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                onClick={toggleTheme}
                className="relative group p-2 rounded-xl hover:bg-muted transition-all"
                ...
                {isLoggedIn && currentUser ? (
                      ...
                      <DropdownMenuContent align="end" className="w-56 bg-card border border-border">
                        ...
                        <div className="px-3 py-2 border-b border-border">
                          ...
                          <div className="flex items-center gap-1 mt-2">
                            ...
                            {hasInfiniteCoins ? (
                              <span className="text-xs font-semibold text-yellow-500 dark:text-yellow-400 flex items-center gap-1">
                        ...
                        >
                          <Sparkles className="mr-2 h-4 w-4 text-purple-500 dark:text-purple-400" />
                          Ir a Explorar
                        </DropdownMenuItem>
                        ...
                        {isAdmin && (
                          <>
                            ...
                            <DropdownMenuItem
                              ...
                              className="cursor-pointer hover:bg-red-500/10 text-red-500 dark:text-red-400"
                            >
                  ...
                  <>
                    <Link href="/login">
                      <Button
                        variant="ghost"
                        className="text-muted-foreground hover:text-foreground hover:bg-muted rounded-xl px-5"
                      >
                        Iniciar Sesion
                      </Button>
                    </Link>
                ...
                {isLoggedIn && currentUser ? (
                  <>
                    ...
                    >
                      ...
                      <div className="relative flex items-center gap-2 bg-card/80 dark:bg-zinc-800/80 border border-border rounded-xl px-2 py-1.5">
                        <Avatar className={`w-7 h-7 border-2 ${isAdmin ? 'border-yellow-500' : 'border-border'}`}>
                          <AvatarImage src={currentUser.avatarUrl} alt={currentUser.username} />
                  ...
                  <>
                    ...
                    >
                      ...
                      <div className="relative p-1 bg-muted dark:bg-gradient-to-br dark:from-zinc-800 dark:to-zinc-900 border border-border group-hover:border-purple-500/30 rounded-lg transition-colors">
