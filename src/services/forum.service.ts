...
class ForumService {
  ...
  async trackShare(postId: string, userId: string | null, shareType: 'clipboard' | 'twitter' | 'whatsapp' | 'facebook' | 'tiktok' | 'telegram' | 'reddit' | 'linkedin' | 'instagram'): Promise<void> {
